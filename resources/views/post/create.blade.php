            ...
            <form action="{{ URL('/post') }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="title" id="name" placeholder="Your title post..."
                        class="w-full rounded-md border border-white bg-white py-3 px-6 text-base font-medium text-text-gray-500 outline-none focus:border-violet-500 focus:shadow-md" />
                </div>
                ...
                <div class="mb-5">
                    ...
                    <textarea rows="4" name="description" id="description" placeholder="Type your article"
                        class="w-full resize-none rounded-md border border-white bg-white py-3 px-6 text-base font-medium text-gray-500 outline-none focus:border-violet-500 focus:shadow-md"></textarea>
                </div>
                <div>
                    <button type="submit"
